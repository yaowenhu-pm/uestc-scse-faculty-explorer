...
const allowed = new Set("profileId name title departments profileUrl researchDirections focusKeywords evidenceGrade evidenceScore evidenceLabel verdict scoreComponents hardSignals highlights limitations evidenceSnippets directoryOrder collectedAt reviewStatus rubricVersion ratingBasis sourceDate ratedAt".split(" "));
